...
namespace ZiraatBankUzPortal.Server.Repositories
{
    public class MenuDataRepository : IMenuDataRepository
    {
        ...
        public MenuDataRepository(IOracleDataAccess orcaleDataAccess, IConfiguration config)
        {
        ...
        {
            Utils.NLogMessage(this.GetType(), $"{"GetAllMenuAsync()"}", Utils.NLogType.Info);
        ...
        {
            Utils.NLogMessage(this.GetType(), $"{"CreateMenuAsync()"}", Utils.NLogType.Info);
            try
            {
                DataOracleParameters parameters = new DataOracleParameters();
        ...
        {
            Utils.NLogMessage(this.GetType(), $"{"GetMenuByPageLink()"}", Utils.NLogType.Info);
            DataOracleParameters parameters = new DataOracleParameters();
